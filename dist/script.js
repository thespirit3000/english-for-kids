...
var handleInput = function handleInput(event) {
  if (event.target.classList.contains('switcher')) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_2__["gameModeSet"])(event.target);
  }
};
...
/*!**************************!*\
  !*** ./src/js/render.js ***!
  \**************************/
/*! exports provided: renderCategoryMenu, renderSideMenu, renderLearnCards */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var renderCategoryMenu = function renderCategoryMenu() {
  ...
  _cards__WEBPACK_IMPORTED_MODULE_1__["default"][0].forEach(function (element) {
    ...
    var category = new _Category__WEBPACK_IMPORTED_MODULE_0__["default"](element, imgUrl, _cards__WEBPACK_IMPORTED_MODULE_1__["default"][0].indexOf(element));
...
var renderSideMenu = function renderSideMenu() {
  ...
  _cards__WEBPACK_IMPORTED_MODULE_1__["default"][0].forEach(function (element) {
    var category = new _Category__WEBPACK_IMPORTED_MODULE_0__["default"](element, '', _cards__WEBPACK_IMPORTED_MODULE_1__["default"][0].indexOf(element));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gameModeSet", function() { return gameModeSet; });
